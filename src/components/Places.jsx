...
function Places() {
  ...
  return (
    <Container>
      ...
      <LinkContainer>
        <Link style={styles.link}>Voir toutes les villes</Link>
        <ChevronRightIcon/>
      </LinkContainer>
      <SlideContainer>
        <SlideContLeft>
          ...
          <SlideLinkContainer>
            <Link style={{fontSize:'17px'}}>Voir tous les avis clients</Link>
            <ChevronRightIcon/>
          </SlideLinkContainer>
        </SlideContLeft>
        <SlideContRight>
          ...
          <Title>
            <StarRateIcon style={{color:'green',fontSize:'25px'}}/>Trustpilot
          </Title>
        </SlideContRight>
      </SlideContainer>
    </Container>
